...
public class LowestTarget : ITargeting
{
    ...
    public LowestTarget(Transform _self_transform, List<CharacterManager> potential_targets) : this(_self_transform, potential_targets, 0f) { }

    public LowestTarget(Transform _self_transform, List<CharacterManager> potential_targets, float _expiration_period)
    {
